...
export default function NameEntry() {
  return (
    ...
    >
      <h1 className="text-7xl font-black tracking-tight mb-4">hi there!</h1>
      <p className="text-2xl font-medium max-w-md leading-snug">
        looks like we’re meeting for the first time! what is your name?
      </p>

      {/* INPUT AREA: Using the Squiggle SVG as a bottom border */}
      ...
      {/* NAV BUTTONS: Anchored to bottom right like mockup */}
